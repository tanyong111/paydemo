package com.ldsj.utils.wxpay;


import java.util.HashMap;
import java.util.Map;

import com.ldsj.utils.wxpay.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        ...
        if (useSandbox) {
            ...
            //this.signType = SignType.HMACSHA256; //解决bug修改的，方便测试，不然由于接收异步通知的时候加密算法不一致，导致验证失败！
